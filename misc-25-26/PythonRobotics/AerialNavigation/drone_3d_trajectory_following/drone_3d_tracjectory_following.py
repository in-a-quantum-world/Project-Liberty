"""
    Simulate a quadroor following a 3D trajectory
"""
...
def quad_sim(x_c, y_c, z_c):
    """
    Calculates the necessary thrust and torques for the quadrotor to follow the
    trajectory described by the sets of coefficients x_c, y_c, and z_c.
    """
    x_pos = -5
    y_pos = -5
    z_pos = 5
    ...
    while True:
        while t <= T:
            ...
            thrust = m * (g + des_z_acc + Kp_z * (des_z_pos - z_pos) + Kd_z * 
                          (des_z_vel - z_vel))
...
def calculate_position(c, t):
    ...
    Args
        c: List of coefficients generated by a quintic polynomial trajectory
           generator.
...
def calculate_velocity(c, t):
    """
    Calculate a velocity given a set of quintic coefficients and a time.
...
def rotation_matrix(roll_array, pitch_array, yaw):
    """
    Calculates the ZYX roation matrix.
...
def main():
    """
    Calculate the x, y, z coefficients for the four segments of the trajectory
    """
    x_coeffs = [[], [], [], []]
    y_coeffs = [[], [], [], []]
    z_coeffs = [[], [], [], []]
